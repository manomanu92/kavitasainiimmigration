  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.mapSection}>
        <iframe
          title="Hashtag Overseas Chandigarh"
          src="https://maps.google.com/maps?q=Hashtag+Overseas+Education+Sector+34A+Chandigarh&t=m&z=15&ie=UTF8&iwloc=near&output=embed"
          width="100%"
          height="450"
